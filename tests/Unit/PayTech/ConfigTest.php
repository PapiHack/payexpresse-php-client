 ...
 */
 ...
 it('Should have XOF currency by default', function() {
     $this->assertSame(\PayExpresse\Enums\Currency::XOF, strtoupper(Config::getCurrency()));
 });
 ...
 it('Should set some Config attributes', function () {
     ...
     Config::setCurrency(\PayExpresse\Enums\Currency::USD);
     Config::setEnv(\PayExpresse\Enums\Environment::TEST);

...
use PayExpresse\Utils\Check;
use PayExpresse\Exceptions\CurrencyException;
 ...
 * 
 */
abstract class Config extends PayExpresse
{
    const ROOT_URL_BASE         = "https://payexpresse.com";
